...
// nolint: dupl
func (qs AdminQuerySet) UserTypeEq(userType string) AdminQuerySet {
	return qs.w(qs.db.Where("user_type = ?", userType))
}

// UserTypeIn is an autogenerated method
// nolint: dupl
func (qs AdminQuerySet) UserTypeIn(userType ...string) AdminQuerySet {
	if len(userType) == 0 {
...
// UserTypeIsNotNull is an autogenerated method
// nolint: dupl
func (qs AdminQuerySet) UserTypeIsNotNull() AdminQuerySet {
	return qs.w(qs.db.Where("user_type IS NOT NULL"))
}

// UserTypeIsNull is an autogenerated method
// nolint: dupl
func (qs AdminQuerySet) UserTypeIsNull() AdminQuerySet {
	return qs.w(qs.db.Where("user_type IS NULL"))
}

// UserTypeLike is an autogenerated method
// nolint: dupl
func (qs AdminQuerySet) UserTypeLike(userType string) AdminQuerySet {
	return qs.w(qs.db.Where("user_type LIKE ?", userType))
}

// UserTypeNe is an autogenerated method
// nolint: dupl
func (qs AdminQuerySet) UserTypeNe(userType string) AdminQuerySet {
	return qs.w(qs.db.Where("user_type != ?", userType))
}

// UserTypeNotIn is an autogenerated method
// nolint: dupl
func (qs AdminQuerySet) UserTypeNotIn(userType ...string) AdminQuerySet {
	if len(userType) == 0 {
...
// UserTypeNotlike is an autogenerated method
// nolint: dupl
func (qs AdminQuerySet) UserTypeNotlike(userType string) AdminQuerySet {
	return qs.w(qs.db.Where("user_type NOT LIKE ?", userType))
}
...
// nolint: dupl
func (u AdminUpdater) SetUserType(userType *string) AdminUpdater {
	u.fields[string(AdminDBSchema.UserType)] = userType
	return u
}
...
var AdminDBSchema = struct {
	...
	UserType:  AdminDBSchemaField("user_type"),
}
...
// EventCodeEq is an autogenerated method
// nolint: dupl
func (qs KeyboardQuerySet) EventCodeEq(eventCode string) KeyboardQuerySet {
	return qs.w(qs.db.Where("event_code = ?", eventCode))
}

// EventCodeIn is an autogenerated method
// nolint: dupl
func (qs KeyboardQuerySet) EventCodeIn(eventCode ...string) KeyboardQuerySet {
	if len(eventCode) == 0 {
		qs.db.AddError(errors.New("must at least pass one eventCode in EventCodeIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("event_code IN (?)", eventCode))
}

// EventCodeIsNotNull is an autogenerated method
// nolint: dupl
func (qs KeyboardQuerySet) EventCodeIsNotNull() KeyboardQuerySet {
	return qs.w(qs.db.Where("event_code IS NOT NULL"))
}

// EventCodeIsNull is an autogenerated method
// nolint: dupl
func (qs KeyboardQuerySet) EventCodeIsNull() KeyboardQuerySet {
	return qs.w(qs.db.Where("event_code IS NULL"))
}

// EventCodeLike is an autogenerated method
// nolint: dupl
func (qs KeyboardQuerySet) EventCodeLike(eventCode string) KeyboardQuerySet {
	return qs.w(qs.db.Where("event_code LIKE ?", eventCode))
}

// EventCodeNe is an autogenerated method
// nolint: dupl
func (qs KeyboardQuerySet) EventCodeNe(eventCode string) KeyboardQuerySet {
	return qs.w(qs.db.Where("event_code != ?", eventCode))
}

// EventCodeNotIn is an autogenerated method
// nolint: dupl
func (qs KeyboardQuerySet) EventCodeNotIn(eventCode ...string) KeyboardQuerySet {
	if len(eventCode) == 0 {
		qs.db.AddError(errors.New("must at least pass one eventCode in EventCodeNotIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("event_code NOT IN (?)", eventCode))
}

// EventCodeNotlike is an autogenerated method
// nolint: dupl
func (qs KeyboardQuerySet) EventCodeNotlike(eventCode string) KeyboardQuerySet {
	return qs.w(qs.db.Where("event_code NOT LIKE ?", eventCode))
}
...
// SetEventCode is an autogenerated method
// nolint: dupl
func (u KeyboardUpdater) SetEventCode(eventCode *string) KeyboardUpdater {
	u.fields[string(KeyboardDBSchema.EventCode)] = eventCode
	return u
}
...
var KeyboardDBSchema = struct {
	...
	EventCode KeyboardDBSchemaField
}{
	...
	EventCode: KeyboardDBSchemaField("event_code"),
}
...
// nolint: dupl
func (qs RtspQuerySet) NameEq(name string) RtspQuerySet {
	return qs.w(qs.db.Where("name = ?", name))
}

// NameIn is an autogenerated method
// nolint: dupl
func (qs RtspQuerySet) NameIn(name ...string) RtspQuerySet {
	if len(name) == 0 {
...
// nolint: dupl
func (qs RtspQuerySet) NameIsNotNull() RtspQuerySet {
	return qs.w(qs.db.Where("name IS NOT NULL"))
}

// NameIsNull is an autogenerated method
// nolint: dupl
func (qs RtspQuerySet) NameIsNull() RtspQuerySet {
	return qs.w(qs.db.Where("name IS NULL"))
}

// NameLike is an autogenerated method
// nolint: dupl
func (qs RtspQuerySet) NameLike(name string) RtspQuerySet {
	return qs.w(qs.db.Where("name LIKE ?", name))
}

// NameNe is an autogenerated method
// nolint: dupl
func (qs RtspQuerySet) NameNe(name string) RtspQuerySet {
	return qs.w(qs.db.Where("name != ?", name))
}

// NameNotIn is an autogenerated method
// nolint: dupl
func (qs RtspQuerySet) NameNotIn(name ...string) RtspQuerySet {
	if len(name) == 0 {
...
// nolint: dupl
func (qs RtspQuerySet) NameNotlike(name string) RtspQuerySet {
...
// nolint: dupl
func (u RtspUpdater) SetName(name *string) RtspUpdater {
	u.fields[string(RtspDBSchema.Name)] = name
	return u
}
