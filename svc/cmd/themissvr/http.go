...
import (
	...
	tokensvr "github.com/JermineHu/themis/svc/gen/http/token/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, healthEndpoints *health.Endpoints, adminEndpoints *admin.Endpoints, configEndpoints *config.Endpoints, keyboardEndpoints *keyboard.Endpoints, hostEndpoints *host.Endpoints, noticeEndpoints *notice.Endpoints, rtspEndpoints *rtsp.Endpoints, tokenEndpoints *token.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
