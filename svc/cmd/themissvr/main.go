...
func main() {
	...
	)
	{
		...
		tokenSvc = themis.NewToken(logger)
	}
	...
	case "development":
		{
			...
			handleHTTPServer(ctx, u, healthEndpoints, adminEndpoints, configEndpoints, keyboardEndpoints, hostEndpoints, noticeEndpoints, rtspEndpoints, tokenEndpoints, &wg, errc, logger, *dbgF)
		}

		{
			...
			handleGRPCServer(ctx, u, healthEndpoints, adminEndpoints, configEndpoints, keyboardEndpoints, hostEndpoints, noticeEndpoints, rtspEndpoints, tokenEndpoints, &wg, errc, logger, *dbgF)
		}
